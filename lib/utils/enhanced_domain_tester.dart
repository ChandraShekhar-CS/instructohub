// File: lib/utils/enhanced_domain_tester.dart
...
class EnhancedDomainTester extends StatefulWidget {
  const EnhancedDomainTester({super.key});

  @override
  State<EnhancedDomainTester> createState() => _EnhancedDomainTesterState();
}

class _EnhancedDomainTesterState extends State<EnhancedDomainTester> {
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Configuration includes smart domain resolution data for enhanced functionality.',
                        style: TextStyle(
                          color: Colors.green,
                          fontSize: 14,
                        ),
